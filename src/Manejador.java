...
public class Manejador extends Thread {
    ...
    public String obtenerParametros(String line, String headers, int bandera) {
        ...
        if (bandera == 0) {
            metodo = "GET";
            // Line: GET /?Nombre=&Apellido=&Telefono= HTTP/1.1
...
"		crossorigin=\"anonymous\"></script><title>Metodo " + metodo + "\n"
                + "</title></head><body class='bg-dark text-white container m-4'><center><h2>Método " + metodo + "</h2><br>\n"
                + "<table class='table table-bordered'><tr><th>Valor</th><th>Valor</th></tr>";
